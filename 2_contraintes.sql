...
-- approvisionner
ALTER TABLE APPROVISIONNER ADD CONSTRAINT chk_prix_achat CHECK (prix_achat_lot > 0);
...
ALTER TABLE PROMOTION ADD CONSTRAINT chk_pourcentage CHECK (pourcentage_reduction BETWEEN 1 AND 100);
 ...
 -- ligne_commande
 ALTER TABLE LIGNE_COMMANDE ADD CONSTRAINT chk_quantite CHECK (quantite_commandee > 0);
